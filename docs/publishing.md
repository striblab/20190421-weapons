...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190421-weapons">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190421-weapons/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190421-weapons/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190421-weapons/",
      "url": "http://static.startribune.com/news/projects/all/20190421-weapons/"
    }
  }
}
```
